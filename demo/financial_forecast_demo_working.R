...
# library(here)
# financials_by_division <- read_csv(paste0(here::here(),'/financials_by_division.csv'))

path <- "C:/Users/TKaduk/Google Drive/r/power_bi_demo"
financials_by_division <- read_csv(paste0(path,'/financials_by_division.csv'))

#financials_by_division <- read_csv('financials_by_division.csv')
